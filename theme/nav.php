  <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          ...
          <div class="collapse navbar-collapse justify-content-end">
            <form class="navbar-form" method="POST" action="<?=baseUrl()?>/panel/search">
              <div class="input-group no-border">
                <input id="search" name="search" type="number" value="" maxlength="11"  class="form-control" placeholder="  09123456789">
            ...
            <ul class="navbar-nav">
              <li class="nav-item">
                <a class="nav-link" href="<?=baseUrl()?>/panel/loadpanel">
